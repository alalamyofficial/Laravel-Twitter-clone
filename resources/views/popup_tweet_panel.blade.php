...
<form action="/tweet/store" method="POST" enctype="multipart/form-data">
    ...
    <textarea  name="body"  id="example2" data-emoji-input="unicode" data-emojiable="true" class="w-full" placeholder="What's up doc ?"></textarea>
    ...
    <footer class="flex justify-between items-center">
        ...
        <img id="blah1"  width="50" height="50" />
